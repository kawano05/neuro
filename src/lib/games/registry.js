...
//
// P0-3 時点では、どのゲームも本実装は無い（rhythm-l1/l2・gonogo・
// calibration は P2〜P4、color-legacy は P1-2 で views/switcher.js から
// 移植する）。gameTiles の enabled は仕様（§4.1）どおり true のままにし、
// 未実装ゲームには createPlaceholderGame() を暫定 create として割り当てる
// （画面を壊さず「じゅんびちゅう」を表示するだけ。おわる/Esc は gameHost が
// ゲーム本体に関わらずホスト側で処理するため、この段階でも安全に終了できる）。
